...
import { LayoutDashboard, BookOpen, QrCode, ClipboardList, User, LogOut, ScanFace } from 'lucide-react';
...
const navItems = [
  ...
  { label: 'Scan QR Code', href: '/student/scan', icon: QrCode },
  { label: 'Face Setup', href: '/student/enroll', icon: ScanFace },
  { label: 'Attendance History', href: '/student/history', icon: ClipboardList },
